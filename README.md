...
**Geo-checker** is a simple and high-performance **GeoIP lookup server** ready for **Docker** and **Kubernetes (K8s)**. Built on **OpenResty (Nginx)** and **MaxMind GeoIP** databases. It provides **IP geolocation validation** by country name, city name, continent name, subdivision name and ISO code.
